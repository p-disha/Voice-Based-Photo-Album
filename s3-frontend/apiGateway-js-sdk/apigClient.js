...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://dzwptd01uf.execute-api.us-east-1.amazonaws.com/gamma';
    ...
    apigClient.photosPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var photosPostRequest = {
        ...
        return apiGatewayClient.makeRequest(photosPostRequest, authType, additionalParams, config.apiKey);
    };
